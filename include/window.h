 ...
 * \sa SendMessage
 */               
MG_EXPORT long int GUIAPI PostMessage (HWND hWnd, int iMsg, 
 ...
 * \sa PostMessage
 */
MG_EXPORT long int GUIAPI SendMessage (HWND hWnd, int iMsg, 
                WPARAM wParam, LPARAM lParam);
 ...
 * \sa SendMessage
 */
MG_EXPORT long int GUIAPI PostSyncMessage (HWND hWnd, int iMsg, WPARAM wParam, LPARAM lParam);
 ...
 * \sa PostSyncMessage
 */
MG_EXPORT long int GUIAPI SendAsyncMessage (HWND hWnd, int iMsg, WPARAM wParam, LPARAM lParam);
#endif
